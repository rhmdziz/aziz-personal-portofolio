  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between pb-10 ">
      <div className="w-full max-w-2xl mx-auto ">
        <div id="header" className="flex mt-12 gap-6">
          <div>
            <Image
              src="/images/aziz.png"
          ...
          <div className="flex flex-col gap-1 items-start justify-center">
            <h1 className="text-2xl text-[var(--gray-primary)]">
              Aziz Rahmad Isnanto
            </h1>
            <p className="text-base text-[var(--gray-secondary)]">
              Mobile developer
            </p>
            {/* <div>
              <a
                ...
                className="text-base text-[var(--gray-secondary)] bg-gray-100 inline-block px-2 py-1 rounded-2xl mt-1 hover:bg-gray-200"
              >
                aziz.com
              </a>
            </div> */}
        ...
        <div id="about" className="mt-10">
          <h2 className="text-base text-[var(--gray-primary)] mb-4">About</h2>
          <p className="text-sm text-[var(--gray-secondary)] leading-relaxed">
        ...
        <div id="experience" className="mt-8">
          <h2 className="text-base text-[var(--gray-primary)] mb-4">
            Experience
          </h2>
            ...
            <div className="w-full">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <p className="text-base text-[var(--gray-primary)] mb-1">
              ...
              <ul className="list-disc list-inside text-sm text-[var(--gray-secondary)] mt-2 leading-relaxed">
                <li>
