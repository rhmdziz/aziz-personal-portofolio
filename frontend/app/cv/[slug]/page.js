  ...
  return (
    <main className="flex min-h-screen flex-col items-center pb-10">
      <div className="flex justify-between items-center mt-12 mb-4">
        <h1 className="text-lg font-medium text-[#111111]">Curriculum Vitae</h1>
        <button
          onClick={handleDownload}
          className="flex items-center gap-2 px-4 py-2 rounded-xl hover:opacity-90 transition cursor-pointer"
        >
              ...
              <div className="w-full">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-base text-[#555555]">{exp.location}</p>
                  </div>
                </div>
